...
namespace TMPro.Examples
{
    ...
    public class VertexZoom : MonoBehaviour
    {
        ...
        /// <summary>
        /// Method to animate vertex colors of a TMP _text object.
        /// </summary>
        /// <returns></returns>
        IEnumerator AnimateVertexColors()
        {
            ...
            while (true)
            {
                ...
                for (int i = 0; i < characterCount; i++)
                {
                    ...
                    //Vector2 charMidBasline = new Vector2((sourceVertices[vertexIndex + 0]._xInput + sourceVertices[vertexIndex + 2]._xInput) / 2, charInfo.baseLine);
                    ...
                    // Restore UncommonSource UVS which have been modified by the sorting
                    ...
                    // Restore UncommonSource Vertex Colors
