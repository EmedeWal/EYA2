...
public class TrackingProjectile : MonoBehaviour
{
    ...
    void Start()
    {
        // Enable the spell after a short delay
    ...
    void Update()
    {
        ...
        {
            // Disable the spell and cast an explosion after the explosion delay
    ...
    private void Explosion()
    {
        ...
        // SpentMana all boxCollider's of the inner explosion
